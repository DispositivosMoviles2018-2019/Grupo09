...
public interface InterfazCRUD<Object>{
     ...
     * @param parametro El parametro del Objeto a ser eliminado
     * @return Un mensaje para alertar al usuario
     */
     ...
     */
    public Object buscarPorParametro(List<Object> lista, String parametro);
